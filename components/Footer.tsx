...
export const Footer = () => {
  return (
    <footer className="bg-dark pt-20 lg:pt-[120px] relative overflow-hidden z-10">
      <div className="container">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full sm:w-2/3 lg:w-4/12 xl:w-3/12 px-4">
            <div className="w-full mb-10">
              ...
              <p className="text-base text-[#8890A4] mb-7">
          ...
          <div className="w-full sm:w-1/2 lg:w-3/12 xl:w-2/12 px-4">
            <div className="w-full mb-10">
          ...
          <div className="w-full sm:w-1/2 lg:w-4/12 xl:w-2/12 px-4">
            <div className="w-full mb-10">
              <h4 className="text-white text-lg font-semibold mb-9">Additional</h4>
              <ul>
                <li>
                  <a
                    href="#"
          ...
          <div className="w-full md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
            <div className="w-full mb-10">
              ...
              <a
                href="#"
                className="flex items-center text-[#8890A4] hover:text-white mb-8"
              >
                <div className="w-full max-w-[70px] rounded mr-5 overflow-hidden">
                  <img
                    src="assets/images/footers/footer-04/blog-01.jpg"
                    alt="image"
                    className="w-full"
                  />
                </div>
              ...
              >
                <div className="w-full max-w-[70px] rounded mr-5 overflow-hidden">
                  <img
                    src="assets/images/footers/footer-04/blog-02.jpg"
                    alt="image"
                    className="w-full"
                  />
                </div>
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full md:w-2/3 lg:w-1/2 px-4">
              <div className="my-1">
                ...
                >
                  <a
                    href="#"
                    className="text-base text-[#8890A4] hover:text-white px-3"
                  >
                    Privacy policy
                  </a>
                  <a
            ...
            <div className="w-full md:w-1/3 lg:w-1/2 px-4">
              <div className="flex justify-center md:justify-end my-1">
                <p className="text-base text-[#8890A4]">&copy; 2025 TailGrids</p>
              </div>
            </div>
          </div>
        </div>
